...
inspect_clusters_to_split(disambiguations["current"], load_israeli_inventors_benchmark()).to_html()
```
...
```{python}
#| column: page
inspect_clusters_to_split(disambiguations["current"], load_patentsview_inventors_benchmark()).to_html()
```
...
```{python}
#| column: page
inspect_clusters_to_merge(disambiguations["current"], load_israeli_inventors_benchmark()).to_html()
```
...
```{python}
#| column: page
inspect_clusters_to_merge(disambiguations["current"], load_patentsview_inventors_benchmark()).to_html()
``` 
