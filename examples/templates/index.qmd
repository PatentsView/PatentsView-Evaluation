...
disambiguations = {filename: read_disambiguation(filename) for filename in ['rawinventor.tsv'] }
```
...
```{python}
#| column: page
style_and_display(inspect_clusters_to_split(disambiguations["rawinventor.tsv"], load_israeli_inventors_benchmark()), by="prediction")
```
...
```{python}
#| column: page
style_and_display(inspect_clusters_to_split(disambiguations["rawinventor.tsv"], load_patentsview_inventors_benchmark()), by="prediction")
```
...
```{python}
#| column: page
style_and_display(inspect_clusters_to_merge(disambiguations["rawinventor.tsv"], load_israeli_inventors_benchmark()), by="reference")
```
...
```{python}
#| column: page
style_and_display(inspect_clusters_to_merge(disambiguations["rawinventor.tsv"], load_patentsview_inventors_benchmark()), by="reference")
``` 
